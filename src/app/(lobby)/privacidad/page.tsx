...
const legacyName = `${siteConfig.name} S.A. de C.V.`
      ...
      <section>
        <div className='container py-spacing-7'>
          ...
          <div className='[&_h2]:f-heading-2 [&_h2]:mt-spacing-7 [&_h2]:pb-spacing-4 [&_p]:f-subhead-2 [&_p]:text-muted-foreground [&_p]:text-balance [&_p]:mt-spacing-4'>
            ...
            <p>
              -{legacyName}- únicamente recopilará información de identificación personal,
              como su nombre  o dirección de correo electrónico, cuando ella sea enviada
              voluntariamente a este sitio web. -{legacyName}- y las empresas que contratamos
            ...
            <p>
              -{legacyName}- realiza esfuerzos razonables para que la Información personal
            ...
            <p>
              -{legacyName}-, <Link href={address.url}>{address.name}</Link> O
              al correo: <Link href={`mailto:${contactEmail}`}>{contactEmail}</Link>
            </p>
            <p>
              -{legacyName}- se compromete a trabajar con las personas para obtener una
              resolución justa de toda queja o disputa sobre la privacidad y la información personal. El compromiso
              de -{legacyName}- con la privacidad queda demostrado y documentado
