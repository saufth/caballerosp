          ...
          <div className='h-full cols-container items-center'>
            ...
            <div className='w-6-cols sm:w-1/2-cols'>
              <div className='relative'>
                ...
                <Icons.Instalations className='w-4/5 sm:w-full lg:w-4/5 h-auto fill-transparent stroke-accent stroke-[4px] absolute inset-x-0 top-0 mx-auto lg:mx-0 scale-110 blur' />
              </div>
            </div>
          </div>
        </div>
